...
import { updateCategory } from "@/lib/actions/sub-categories";

type Props = {
  categories: CategoryController.Category[];
  subcategory: SubCategoryController.Category;
...
const EditForm = ({ images, categories, id, subcategory }: Props) => {
  ...
  const form = useForm<FormSchema>({
    ...
    defaultValues: {
      ...
      imageId: subcategory.imageId ? subcategory.imageId.toString() : "",
      bannerId: subcategory.bannerId ? subcategory.bannerId.toString() : "",
