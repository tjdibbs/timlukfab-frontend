...
import { deleteCategory } from "@/lib/actions/sub-categories";

export const columns: ColumnDef<SubCategoryController.Category>[] = [
  {
    accessorKey: "S/N",
        ...
        <Fragment>
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem>
                <Link href={`/admin/sub-categories/edit/${rowData.id}`}>
                  Edit
                </Link>
              </DropdownMenuItem>
